...
data class RepositoryInfoDetails (
    ...
    @SerializedName("owner"                       ) var owner                    : Owner2?            = Owner2(),
    ...
    @SerializedName("temp_clone_token"            ) var tempCloneToken           : String?           = null,
    //@SerializedName("custom_properties"           ) var customProperties         : CustomProperties? = CustomProperties(),
    @SerializedName("organization"                ) var organization             : Organization?     = Organization(),
    @SerializedName("network_count"               ) var networkCount             : Int?              = null,
    @SerializedName("subscribers_count"           ) var subscribersCount         : Int?              = null
